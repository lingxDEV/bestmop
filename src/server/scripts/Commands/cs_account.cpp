...
public:
    ...
    ChatCommand* GetCommands() const
    {
		...
		{
			{ "add", SEC_ADMINISTRATOR, true, &HandleAccountBoostAddCommand, "", NULL },
			{ "delete", SEC_ADMINISTRATOR, true, &HandleAccountBoostDelCommand, "", NULL },
        ...
        static ChatCommand accountCommandTable[] =
        {
			...
			{ "boost",			SEC_ADMINISTRATOR, false, NULL, "", accountBoostCommandTable },
