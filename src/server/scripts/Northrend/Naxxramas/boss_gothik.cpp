...
struct NotOnSameSide : public zonaxtrema::unary_function<Unit*, bool>
{
    ...
    public:
        ...
        struct boss_gothikAI : public BossAI
        {
            ...
            void SpellHit(Unit* /*caster*/, SpellInfo const* spell)
            {
                ...
                {
                    me->HandleEmote(EMOTE_ONESHOT_SPELL_CAST);
...
class spell_gothik_shadow_bolt_volley : public SpellScriptLoader
{
    public:
        ...
        class spell_gothik_shadow_bolt_volley_SpellScript : public SpellScript
        {
            ...
            {
                targets.remove_if(WoWSource::UnitAuraCheck(false, SPELL_SHADOW_MARK));
            }
