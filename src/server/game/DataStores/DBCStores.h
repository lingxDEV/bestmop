...
extern std::map<uint32, std::set<ResearchProjectEntry const*>>     sResearchProjectMap;
...
extern std::map<uint32 /*spellId*/, SpellItemEnchantmentEntry const*> sSpellEnchantScalingData;
