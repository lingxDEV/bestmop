...
struct SpellItemEnchantmentEntry
{
    ...
    uint32      MaxLevel;                                   // 22       new in 3.1, look like level (max)?
    uint32      ItemLevel;                                  // 23       m_ilvl
    int32       ScalingClass;                               // 24
    int32       ScalingClassRestricted;                     // 25
    float       ScalingPoints[MAX_ITEM_ENCHANTMENT_EFFECTS];// 26-28
};
