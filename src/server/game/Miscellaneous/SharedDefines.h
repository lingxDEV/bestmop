...
enum SpellEffects
{
    ...
    SPELL_EFFECT_FORCE_PLAYER_INTERACTION           = 160, // SPELL_EFFECT_FORCECAST_TRIGGER_SPELL. NYI.
    ...
    SPELL_EFFECT_DESPAWN_AREA_TRIGGER               = 177, // SPELL_EFFECT_DESPAWN_PERSISTENT_AREA_AURAS. Check 137182. NYI.
    ...
    SPELL_EFFECT_DESPAWN_AREA_TRIGGER_2             = 182, // SPELL_EFFECT_DESPAWN_AREA_TRIGGER. NYI.
    ...
    SPELL_EFFECT_PLAY_SCENEOBJECT                   = 185, // Scene related
    SPELL_EFFECT_PLAY_SCENEOBJECT_2                 = 186, // Scene related
    ...
    SPELL_EFFECT_PLAY_SCENE                         = 198, // Mini scene event
    ...
    SPELL_EFFECT_REMOVE_AURA_2                      = 203, // Unk 5.4.0
...
{   // (C) used in caster aura state     (T) used in target aura state
	...
	AURA_STATE_BG_PREPARATION               = 20,           //  c  | only (45317 Suicide)
...
enum ChatMsg
{
    ...
    CHAT_MSG_ARENA_POINTS                       = 48, // Unused
    ...
    CHAT_MSG_CURRENCY                           = 62,
    CHAT_MSG_QUEST_BOSS_EMOTE                   = 63,
...
enum TradeStatus
{
    ...
    TRADE_STATUS_NO_TARGET = 1,
    // 2 - unk
    // 3 - unk
    // 4 - unk
    TRADE_STATUS_YOU_LOGOUT = 5,
    // 6 - unk
    TRADE_STATUS_ONLY_CONJURED = 7,
    TRADE_STATUS_NOT_ELIGIBLE = 8,
    TRADE_STATUS_TARGET_LOGOUT = 9,
    // 10 - unk
    // 11 - unk
    // 12 - unk
    TRADE_STATUS_TARGET_DEAD = 13,
    // 14 - unk
    TRADE_STATUS_BEGIN_TRADE = 15,
    TRADE_STATUS_YOU_DEAD = 16,
    TRADE_STATUS_BUSY = 17,
    // 18 - unk
    TRADE_STATUS_TRADE_CANCELED = 19,
    TRADE_STATUS_CLOSE_WINDOW = 20,
    TRADE_STATUS_BUSY_2 = 21,
    TRADE_STATUS_WRONG_FACTION  = 22,
    TRADE_STATUS_TRADE_ACCEPT = 23,
    TRADE_STATUS_TARGET_TO_FAR = 24,
    // 25 - unk
    TRADE_STATUS_TRADE_COMPLETE = 26,
    TRADE_STATUS_OPEN_WINDOW    = 27,
...
// Instance difficulty flag masks
enum DungeonStatusFlag
{
    ...
    RAID_STATUSFLAG_1025MAN_FLEX = 0x16,
    RAID_STATUSFLAG_25MAN_LFR    = 0x32,
    RAID_STATUSFLAG_40MAN        = 0x64,
