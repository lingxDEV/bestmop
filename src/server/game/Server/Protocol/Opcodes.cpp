...
void InitOpcodes()
{
    ...
    //DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_PORT,                        STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBfPortOpcode              );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEGROUND_LEAVE,                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlegroundLeaveOpcode   );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEGROUND_LIST,                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlegroundListOpcode    );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEGROUND_PORT,                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlegroundPortOpcode    );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEGROUND_SEND_TIMER,                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSendBattlegroundTimer     );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEGROUND_STATUS,                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlegroundStatusOpcode  );
	...
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PRODUCT_LIST,				STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE,			STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_NULL);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE,	STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_NULL);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_TO_TARGET, STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_NULL);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_DISTRIBUTION_SELECT_CHOICE,	STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_NULL);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PURCHASE_LIST,			STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_NULL);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_START_PURCHASE,				STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_NULL);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_CHAR_BOOST,						STATUS_AUTHED,	  PROCESS_THREADUNSAFE, &WorldSession::HandleBattleCharBoost		   ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_QUERY_NAME,                   STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetQueryName        );
    ...
    //DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_ENABLE,                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_ENTER_INSTANCE,              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_EXIT_INSTANCE,               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_GET_MAP_INFO,                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_GET_PARTY_INFO,              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_GET_PLAYER_INFO,             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_INSTANCE_COMMAND,            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_SKIRMISH_QUEUE_COMMAND,      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_COMMENTATOR_START_WARGAME,               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_COMPLETE_MOVIE,                          STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCompleteMovie             );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GMTICKET_GETWEBTICKET,                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketGetWebTicketOpcode);
    ...
    //DEFINE_OPCODE_HANDLER(CMSG_GUILD_REQUEST_CHALLENGE_INFO,            STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_SET_ACHIEVEMENT_TRACKING,          STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_SET_GUILD_MASTER,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildLeaderOpcode         );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_HEARTH_AND_RESURRECT,                    STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleHearthAndResurrect);
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LFG_LOCK_INFO_REQUEST,                   STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgLockInfoRequestOpcode  );
    ...
    //DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_ADDON_GUILD,                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode    ); // This generates a huge lag
    ...
    //DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_WALK_SPEED_CHANGE_ACK,        STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_RUN_SPEED_CHANGE_ACK,         STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_SWIM_SPEED_CHANGE_ACK,        STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_MOVE_WATER_WALK_ACK,                     STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_FLIGHT_SPEED_CHANGE_ACK,      STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_RUN_BACK_SPEED_CHANGE_ACK,    STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_SWIM_BACK_SPEED_CHANGE_ACK,   STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_COLLISION_HEIGHT_ACK,           STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes           );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PLAYER_DIFFICULTY_CHANGE,                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChangePlayerDifficulty    );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_PVP_REWARDS,                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRequestPvpRewards         );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_RATED_BG_INFO,                   STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleRequestRatedBgInfo        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_LFG_BONUS_FACTION,                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetLfgBonusFactionOpcode  );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SHOP_CONTENT_REQUEST,                    STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleShopDataRequest           );
	...
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_SUMMON_COMPANION,				STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSummonBattlePet		   );	//
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_CAGE,							STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetCage			   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_DELETE,						STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetDelete		   );
	//DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_DELETE,						STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetDelete		   );
	...
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_JOURNAL_LOCK_DENINED,         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_UPDATE,						STATUS_NEVER,	  PROCESS_INPLACE,		&WorldSession::Handle_ServerSide			   );
	//DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_DELETE,                        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_DELETED,                      STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	//DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_NAME_QUERY_RESPONSE,           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_QUERY_NAME_RESPONSE,          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	//DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_UNK0,							STATUS_NEVER,	  PROCESS_INPLACE,      &WorldSession::Handle_ServerSide			   );
    DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_CREATE_ERROR,					STATUS_NEVER,	  PROCESS_INPLACE,      &WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_QUEUE_STATUS,					STATUS_NEVER,	  PROCESS_INPLACE,      &WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_GAME_FOUNDED,					STATUS_NEVER,	  PROCESS_INPLACE,      &WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_POSITION,						STATUS_NEVER,	  PROCESS_INPLACE,      &WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_INITIAL,						STATUS_NEVER,	  PROCESS_INPLACE,		&WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_EVENT_AT_START,				STATUS_NEVER,	  PROCESS_INPLACE,		&WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_EVENT_2,						STATUS_NEVER,	  PROCESS_INPLACE,		&WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_REWARD,						STATUS_NEVER,	  PROCESS_INPLACE,		&WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_UNK8,							STATUS_NEVER,	  PROCESS_INPLACE,		&WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_TRAP_TIME_ERROR,				STATUS_NEVER,     PROCESS_INPLACE,		&WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_END,							STATUS_NEVER,	  PROCESS_INPLACE,		&WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_SWAP_REQ,						STATUS_NEVER,	  PROCESS_INPLACE,		&WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_START_PVP_DUEL_REQUEST,		STATUS_NEVER,	  PROCESS_INPLACE,		&WorldSession::Handle_ServerSide			   );
	DEFINE_OPCODE_HANDLER(CMSM_BATTLE_PET_START_PVP_MATCHMAKING,		STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetStartPvPMatchMaking);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_STOP_PVP_MATCHMAKING,			STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetStopPvPMatchMaking);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_ACCEPT_QUEUED_PVP_MATCH,		STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetAcceptPvpMatchMaking);
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_ACTION,						STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleAction		   );
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_SET_ACTIVE_PET,				STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleSetActivePet	   );
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_END,							STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleEnd			   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_START_PVP_DUEL,				STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetStartPvPDuel	   );
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_ACCEPT_PVP_DUEL,				STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetAcceptPvPDuel    );
	/*END*/
	...
	DEFINE_OPCODE_HANDLER(CMSG_WARGAME_ACCEPT,							STATUS_LOGGEDIN, PROCESS_INPLACE,		&WorldSession::HandleAcceptWarGameInvite);
	DEFINE_OPCODE_HANDLER(CMSG_WARGAME_START,							STATUS_LOGGEDIN, PROCESS_INPLACE,		&WorldSession::HandleStartWarGame);
    ...
    //DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_RUN_MODE,                        STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_WALK_MODE,                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_WORLDPORT_ACK,                       STATUS_TRANSFER,  PROCESS_THREADUNSAFE, &WorldSession::HandleMoveWorldportAckOpcode    );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_ALL_ACCOUNT_CRITERIA,                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ATTACK_SWING_RESULT,                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEGROUND_LIST,                       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEGROUND_STATUS,                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEGROUND_STATUS_ACTIVE,              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEGROUND_STATUS_FAILED,              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEGROUND_STATUS_NEED_CONFIRMATION,   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEGROUND_STATUS_QUEUED,              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    // DEFINE_OPCODE_HANDLER(SMSG_BATTLEGROUND_STATUS_WARGAMES,            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_CAGE_DATA_ERROR,               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_DELETE,                        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_ERROR,                         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_HEALED,                        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );     
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_LICENSE_CHANGED,               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_NAME_QUERY_RESPONSE,           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_TRAP_LEVEL,                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLEPET_UPDATE,                        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_CHAT_RESTRICTED,              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_DEBUG_QUEUE_DUMP_RESPONSE,    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_QUEUE_PROPOSE_MATCH,          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );    
    //DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PET_ROUND_RESULT,                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BLACKMARKET_OPEN_RESULT,                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_BLACKMARKET_OUT_BID,                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_BLACKMARKET_ITEM_RESULT,                 STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_BLACKMARKET_BID_ON_ITEM_RESULT,          STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_BLACKMARKET_WON,                         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_BONUS_ROLL_EMPTY,                        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_DELETE_LEADER_RESULT,     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_REWARDS,                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	DEFINE_OPCODE_HANDLER(SMSG_CHARACTER_UPGRADE_STARTED,				STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE,			STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_ACK_FAILED,					STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_CONFIRM_PURCHASE,				STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_DELIVERY_ENDED,				STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_DELIVERY_STARTED,				STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE, STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE,	STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE,	STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_PURCHASE_UPDATE,				STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE, STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_DISTRIBUTION_MAKE_PRODUCT_CHOICE_RESPONSE, STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE,		STATUS_UNHANDLED, PROCESS_INPLACE, &WorldSession::Handle_ServerSide);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_ACTIVATE_ANIM_KIT,            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_PLAY_SPELL_VISUAL,            STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PENDING_RAID_LOCK,                       STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_MASTER_CANDIDATE_LIST,              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ROLLS_COMPLETE,                     STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MINIMAP_PING,                            STATUS_NEVER,     PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_MOVE_TIME_SKIPPED,                       STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PLAYER_DIFFICULTY_CHANGE_RESULT,         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_PLAYER_SAVE_GUILD_EMBLEM,                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_PLAYER_TABARD_VENDOR_SHOW,               STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_PLAY_SCENE,                              STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUERY_NEXT_MAIL_TIME,                    STATUS_NEVER,     PROCESS_THREADUNSAFE, &WorldSession::Handle_ServerSide               );
    ...
    // DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_CREDIT_SIMPLE,           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_PVP_CREDIT,              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_FAILED_TIMER,                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_SET_VIGNETTE,                            STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_SHOP_AUTH_BUY_FAILED,                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_SHOP_CONTENT_RESPONSE,                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    //DEFINE_OPCODE_HANDLER(SMSG_SHOP_INGAME_BUY_FAILED,                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	DEFINE_OPCODE_HANDLER(SMSG_WARGAME_CHECK_ENTRY,						STATUS_LOGGEDIN, PROCESS_INPLACE,		&WorldSession::Handle_ServerSide);
    ...
    // These opcodes are not in WPP. They are Obsolete / Deprecated or NotFoundYet.
