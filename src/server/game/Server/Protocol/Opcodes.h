...
enum Opcodes
{
    ...
    CMSG_GUILD_REPLACE_GUILD_MASTER                   = 0x1D9C, // 5.4.7 18019
    CMSG_GUILD_REQUEST_CHALLENGE_INFO                 = 0X0000, 
    ...
    CMSG_SET_LFG_BONUS_FACTION                        = 0x147A, // 5.4.7 18019
    ...
    CMSG_OPT_OUT_OF_LOOT                              = 0x1177, // 5.4.7 18019
	...
	CMSG_WARGAME_ACCEPT								  = 0x1113,
	CMSG_WARGAME_START								  = 0x0D8B,
    ...
    SMSG_ARENA_OPPONENT_SPECIALIZATIONS               = 0xF69, // 5.4.7 18019
    ...
    SMSG_GUILD_EVENT_NEW_LEADER                       = 0x187A,
    ...
    SMSG_LOOT_LIST                                    = 0x177B, // 5.4.7 18019
	...
	SMSG_WARGAME_CHECK_ENTRY						  = 0x0740,
    ...
    SMSG_LOSS_OF_CONTROL_AURA_UPDATE                  = 0x12A1,
    SMSG_APPLY_MOVEMENT_FORCE                         = 0x1232,
    SMSG_UNAPPLY_MOVEMENT_FORCE                       = 0x133B,
    SMSG_MOVE_SET_CAN_TURN_WHILE_FALLING              = 0x1D83, //5.4.7 18019
    SMSG_MOVE_UNSET_CAN_TURN_WHILE_FALLING            = 0x09B9, //5.4.7 18019
	...
	/*BATTLEPET*/
	CMSG_BATTLE_PET_QUERY_NAME									= 0x16E0, // 5.4.7 18019 Not implemented - CHECK!
	CMSG_REQUEST_BATTLEPET_JOURNAL								= 0x12C1, // 5.4.7 18019
	//SMSG_BATTLEPET_CAGE_DATA_ERROR								= 0x14A1, // 5.4.7 18019 Not implemented - CHECK! These concern actual pets. Wrong Opcode Number
	SMSG_BATTLEPET_ERROR										= 0x1C12, // 5.4.7 18019 Not implemented - CHECK!
	SMSG_BATTLEPET_HEALED										= 0x0000, // Check 0x1C3B.
	SMSG_BATTLE_PET_JOURNAL										= 0x14A0, // 5.4.7 18019
	...
	CMSG_BATTLE_PET_CAGE										= 0x13A8,
	CMSG_BATTLE_PET_DELETE										= 0x1893,
	CMSG_BATTLE_PET_MODIFY_NAME									= 0x19B9,
	CMSG_BATTLE_PET_SET_BATTLE_SLOT								= 0x1388,
	CMSG_BATTLE_PET_SET_FLAGS									= 0x123B,
	CMSG_BATTLE_PET_SUMMON_COMPANION							= 0x17C0,
	SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED						= 0x1C7A,
	SMSG_BATTLE_PET_JOURNAL_LOCK_DENINED						= 0x13E3,	
	SMSG_BATTLE_PET_UPDATE										= 0x157A,
	SMSG_BATTLE_PET_DELETED										= 0x13F1,
	SMSG_BATTLE_PET_QUERY_NAME_RESPONSE							= 0x0D01,
	

	CMSM_BATTLE_PET_START_PVP_MATCHMAKING						= 0x13B0,
	CMSG_BATTLE_PET_STOP_PVP_MATCHMAKING						= 0x1C73,
	CMSG_BATTLE_PET_ACCEPT_QUEUED_PVP_MATCH						= 0x11E2, // accept or decline
	CMSG_BATTLE_PET_ACTION										= 0x1283,
	CMSG_PET_BATTLE_SET_ACTIVE_PET								= 0x1788,
	CMSG_PET_BATTLE_END											= 0x4A9,
	CMSG_BATTLE_PET_START_PVP_DUEL							    = 0x13A0,
	CMSG_BATTLE_PET_ACCEPT_PVP_DUEL								= 0x1D13, // accert or decline

	SMSG_BATTLE_PET_START_PVP_DUEL_REQUEST						= 0x1C08,
	//SMSG_BATTLE_PET_UNK0										= 6010,
	SMSG_PET_BATTLE_GAME_FOUNDED								= 0x0E62, // battle pet game founded
	SMSG_PET_BATTLE_CREATE_ERROR								= 0x163A,
	SMSG_BATTLE_PET_QUEUE_STATUS								= 0x1540, // battle pet queue update status
	SMSG_PET_BATTLE_POSITION									= 0x0469, // battle pet after accept join to game

	SMSG_PET_BATTLE_INITIAL										= 0x01E3,
	SMSG_PET_BATTLE_EVENT_AT_START								= 0x1612,
	SMSG_PET_BATTLE_EVENT_2										= 0x0709,
	SMSG_PET_BATTLE_REWARD										= 0x12F0,
	SMSG_BATTLE_PET_UNK8										= 5034,
	SMSG_BATTLE_PET_TRAP_TIME_ERROR								= 3211,
	SMSG_PET_BATTLE_END											= 0x1E33,
	SMSG_PET_BATTLE_SWAP_REQ									= 0x0891, // sub_35C19D
	/*END*/

	SMSG_DISPLAY_TOAST											= 0x1D5A,

	CMSG_BATTLE_CHAR_BOOST = 0x08E3, // 5.4.8 18414
	CMSG_BATTLE_PAY_GET_PRODUCT_LIST = 0x0DE0,
	CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE = 0x0000,
	CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE = 0x0000,
	...
	CMSG_BATTLE_PAY_START_PURCHASE = 0x0000,

	SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE = 0x0116, // 5.4.8 18414
	...
	SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE = 0x0CAF,
	...
	SMSG_BATTLE_PAY_START_DISTRIBUTION_MAKE_PRODUCT_CHOICE_RESPONSE = 0x0000,
