...
struct DefaultTargetSelector : public zonaxtrema::unary_function<Unit*, bool>
{
    const Unit* me;
    float m_dist;
    bool m_playerOnly;
...
struct SpellTargetSelector : public zonaxtrema::unary_function<Unit*, bool>
{
    public:
...
struct NonTankTargetSelector : public zonaxtrema::unary_function<Unit*, bool>
{
    public:
...
class UnitAI
{
    ...
    public:
        ...
        // predicate shall extend zonaxtrema::unary_function<Unit*, bool>
