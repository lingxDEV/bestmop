...
enum WorldIntConfigs
{
	...
	CONFIG_ANTICHEAT_TELEPORTHACKDETECTION_DISTANCE,
    ...
    CONFIG_CURRENCY_TYPE_1_TRADE_RATE,
    CONFIG_CURRENCY_TYPE_2_TRADE_RATE,
    CONFIG_CURRENCY_TYPE_3_TRADE_RATE,
    CONFIG_CURRENCY_TYPE_4_TRADE_RATE,
...
enum WorldStates
{
	WS_CURRENCY_RESET_TIME               = 20001,           // Next weekly currency reset time
...
class World
{
    public:
		...
		void SetAntifreezStatus(bool aStatus)  { m_antiFreezStatus = aStatus; }
		bool GetAntiFreezStatus() { return m_antiFreezStatus; }
